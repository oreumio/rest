 ...
 */
@Entity
@Table(name = "EML_MAIL_FORM_FROM")
public class EmlMailFormFrom {
    ...
    public EmlMailFormFrom() {
    }

    public EmlMailFormFrom(EmlMailFormFromVo emlAddressVo) {
