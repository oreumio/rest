...
public class EmlReadConfirm implements Serializable {
	 ...
	 * 처음 읽은 일시
	 */
	@Column(name = "FIRST_READ_DT", nullable = true)
	...
	/**
	 * @param firstReadDt the firstReadDt to set
	 */
